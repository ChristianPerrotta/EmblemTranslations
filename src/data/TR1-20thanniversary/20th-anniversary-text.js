export const book20th = [
    ...
    [
        ...
        [//tag 3
            "p",
            "I have been a producer for the entire series after 'The Blazing Blade'.",
            "『烈火の剣』以降、すべてのシリーズのプロデューサーをしています。"
        ],
        [//tag 4
            "p",
            'At that time, we were developing the game on the GBA. However, since the Famicom era, I had always been a huge fan of Fire Emblem as a TV game player, and I had a strong desire within me that said, "I want to play it on TV again someday!" So, once I became a producer, I strongly believed that I wanted to make this dream come true. I pondered on how we could bring it back as a TV game once again, and as a result, I made the decision to expand overseas first and increase the fan base for this game. I still remember the moment I first told Mr. Narihiro about this idea, and he asked me, "Are you serious?"',
            "この当時はGBAで制作していましたが、FC時代から『ファイアーエムブレム』はTVゲームユーザーとして大好きだったので、私には「いつかもう一度TVで遊びたい！」という思いがありました。そして、私がプロデューサーになる以上、この夢を実現したいと強く考えていました。どうすればもう一度TVゲームとして作ることができるかを考え、その結果、まず海外に進出し、このゲームのファンを増やすという決断をしました。初めて成広さんにこの話をしたとき、「本気ですか」と言われたことを今でも思い出します。"
        ],
        [//tag 5
            "p",
            'With "The Blazing Blade," we successfully expanded into North America and Europe, and with "Path of Radiance," we were able to fulfill my long-held desire to bring the series back to a TV console. I deeply appreciate that this accomplishment was made possible by the fans of this series from all around the world who love and support it. Moving forward, I aspire to continue creating even more captivating Fire Emblem games. I kindly ask for your continued support.',
            "『烈火の剣』で北米、欧州進出を成功させ、そして『蒼炎の軌跡』で私の念願であったTVに復帰させることができました。これも、このシリーズを愛してくださる世界中のファンの皆様のお陰だと痛感しています。今後もより魅力的な『ファイアーエムブレム』を作っていきたいと考えていますので、皆様どうぞ応援をよろしくお願いします。"
        ],
        [//tag 6
            "h4",
            "Profile",
        ...
        [//tag 7
            "p",
            `Nintendo Co., Ltd., Planning and Development Division, Planning and Development Department, 2nd Production Group, Group Manager/Producer for the "Fire Emblem" series since "The Blazing Blade." Additionally, I have worked on numerous other series such as "Yoshi's Cookie," "Panel de Pon," "Sin and Punishment," and "The Legendary Starfy."`,
            "任天堂株式会社　企画開発本部　企画開発部　第２プロダクショングループ　グループマネージャー／『烈火の剣』以降『ファイアーエムブレム』シリーズのプロデューサーを担当。そのほかにも、『ヨッシーのクッキー』『パネルでポン』『罪と罰』『伝説のスタフィー』など、多数のシリーズを手がけている。"
        ], ["hr"],
        [//tag 8
            "h3",
            "Narihiro Toru",
        ...
        [//tag 9
            "p",
            `It has already been 20 years, hasn't it? I believe this is a momentous occasion made possible by the support of many fans throughout the years. When we first started creating games, the concept of the game industry as we know it today didn't even exist. We were both the creators and the players, driven by passion and enthusiasm, naturally coming together to create something we ourselves wanted to play. It was in this environment that the idea sparked: "What if we combine simulation elements with a narrative similar to an RPG? Would it make the game even more enjoyable?" And that's how "Fire Emblem" (hereafter referred to as "FE") was born.`,
            "もう20年も経ったんですね。これも今まで多くのファンの皆様に支えられてこその記念すべき出来事だと思います。ゲームを作り始めた当時はまだゲーム業界というものすらなかった時代で、作りても遊び手も一緒で、熱意と意欲を持った人たちが自然と集まって、楽しみながら、自分たちが遊びたいものをただひたすら作っていました。そんな中で、シミュレーションにもRPGのような物語を乗っけるともっと面白くなるのでは？、という思いから『ファイアーエムブレム（以下『FE』）』が生まれたんです。"
        ],
        [//tag 10
            "p",
            `The most memorable game in the FE series for me is "Genealogy of the Holy War." By introducing the new love system, it opened up possibilities for what is commonly known as "pairing up" or "shipping" characters, allowing players to have a playstyle like "I want them to fight together!" Each move and action took on greater significance, leading to a wider range of variations in how players maneuvered their pieces on the board.`,
            "僕が『FE』シリーズで、いちばん思い出深いのは『聖戦の系譜』。恋愛システムを新しく取り入れたことで、いわゆるカップリングというか、「一緒に戦わせたい！」というような遊び方も出てきた、今まで以上に一手一手が意味を成し、プレイヤーの駒の動かし方にバリエーションが生まれました。"
        ],
        [//tag 11
            "p",
            `Moreover, it was quite challenging to prepare multiple endings. I wonder how many people actually managed to see them all? (laughs) Additionally, when it comes to FE, characters play a significant role. My personal favorite character is Travant. I believe Travant symbolizes FE in many ways. Among the human relationships depicted at that time, he stood out with a remarkable presence. Personally, I also like Astrid and Homer.`,
            "それに、エンディングも複数用意して本当に大変でした。どれだけの人に全部見ていただけたのかな？（笑）また、『FE』といえばキャラクターですね。ぼくがキャラクターでいちばん好きなのはトラバント。トラバントって『FE』を象徴していると思うんです。あのとき描かれていた人間模様の中で、ひと際存在感がありましたね。それから個人的には、ステラやホメロスも好きです。"
        ],
        [//tag 12
            "p",
            `The other day, a friend of mine said to me, "FE is a game where it takes a long time for players to receive rewards." It's true that, as a game, it has simple mechanics, but there's a lot to learn at the beginning... This has always been an eternal challenge for us. However, I want to convey the profound joy that comes from mastering those skills, and I want to place even greater importance on the rewards players receive when they clear the game. Moreover, although the game revolves around "battle" and "bonds," it's the realistic aspect, different from a simple tale of good versus evil, that gives this game its unique flavor. While it may be "just a game," I hope it can convey something meaningful to the hearts of players.`,
            "先日知人に「『FE』って、遊んだ人に対してごほうびがかえってくるまでが長いゲームだよね」って言われたんです。確かに、遊びとしてはシンプルなのだけど、はじめに覚えてもらうことが多いので…。ここは永遠の課題なのですが、でも、覚えたことによって得られる深い喜びは伝えていきたいですし、クリアしたときのごほうびはもっと大切にしていきたいです。そして、“戦い”と“絆”をテーマにしているけど、勧善懲悪じゃないところにリアリティーがあるのが、このゲームの味だと思っています。たかがゲームだけど、何かプレイヤーの心に伝えられるものがあればいいなと思っています。"
        ],
        [//tag 13
            "p",
            `In "FE," while there is a narrative aspect, we are merely providing the vessel or the catalyst. It is through the act of playing that each individual engraves their own unique memories and history within themselves. The game is completed when players experience it, make their own choices, and ultimately clear it. Therefore, I am truly grateful to those who take the time to thoroughly enjoy and play their own version of "FE." Thank you sincerely.`,
            "『FE』には、物語的なものはあるけど、ぼくたちはただ器というか、きっかけを作っているにすぎなくて、皆さんがプレイすることでそれぞれの人の中に違う思い出や歴史を刻みながら、クリアしてもらってやっと完成するゲーム。だから遊んでくれている人はじっくりと自分の『FE』を遊んでくれている…。本当に感謝しています。"
        ],
        [//tag 14
            "p",
            `I will continue to create vessels that will allow you to enjoy even more, so I hope you can look forward to it and await with anticipation!`,
            "これからももっともと楽しんでもらえるための器を作っていきますので、楽しみにお待ちいただけたらと思います！"
        ],
        [//tag 15
            "h4",
            "Profile",
        ...
        [//tag 16
            "p",
            'Intelligent Systems Co., Ltd., General Development Department, Producer/As for notable software that I have been involved in producing or developing, there are the "Famicom Wars" series and the "Fire Emblem" series, among others.',
            "株式会社インテリジェントシステムズ　総合開発部　プロデューサー／制作やプロデュースに携わったおもなソフトとして、『ファミコンウォーズ』シリーズ、『ファイアーエムブレム』シリーズ等がある。"
        ]
    ],
    //page 3
    [
        ...
        [
            "h2",
            "Gallery & Interview ...... 217",
            "Gallery & Interview ...... 217"
        ],
        [
            "h4",
            "　Fire Emblem<br>　Trading Card Game Illustrations Collection ...... 218",
            "　ファイアーエムブレム<br>　トレーディングカードゲームイラストコレクション ...... 218"
        ],
        [
            "h4",
            "　'Archanea Saga' Illustration Gallery ...... 230",
            "　『アカネイア戦記』イラストギャラリー ...... 230"
        ],
        [
            "h4",
            "　'New Mystery of the Emblem' Character Illustration Collection ...... 234",
            "　『新・紋章の謎』キャラクターイラスト集 ...... 234"
        ],
        [
            "h4",
            "　Special Interview: Yuka Tsujiyoko ...... 238",
            "　スペシャルインタビュー辻横由佳 ...... 238"
        ],
        [
            "h4",
        ...
        [
            "h4",
            "　Portrait Transition History ...... 68",
            "　肖像変遷樹 ...... 68"
        ],
        [
            "h4",
            "　Lineage of Red-and-Green ...... 70",
            "　赤緑の系譜 ...... 70"
        ],
        [
            "h4",
            "　Lineage of 'Triangle Attack!' ...... 108",
            "　トライアングルアタック！の系譜 ...... 108"
        ],
        [
            "h4",
            "　Another Elibe Saga ...... 157",
            "　もうひとつのエレブサーガ ...... 157"
        ],
        [
            "h4",
            "　Hero's Battle: 'Smash Bros.' On-the-Go Edition ...... 158",
            "　勇者の戦い『スマブラ』出張編 ...... 158"
        ],
        [
            "h4",
            "　'Path of Radiance' Movie Setting Illustrations ...... 216",
            "　『蒼炎の軌跡』ムービー用設定イラスト ...... 216"
        ],
        [
            "p",
            `* In the "World Guide," abbreviated titles are used to indicate the source work of each character illustration for the purpose of distinguishing them based on the respective appearances in each installment. Here is a guide to understanding the abbreviations:`,
            "※「ワールドガイド」では、キャラクターの各イラストがどの作品登場時のものかを判別するため、イラストの出典作品を略称で明記しています。略称の見方は以下のとおりです。"
        ],
        [
            "p",
            "(SDBL) ... Shadow Dragon and the Blade of Light",
            "【暗黒竜】……　暗黒竜と光の剣"
        ],
        [
            "p",
            "(MotE) ... Mystery of the Emblem",
            "【紋章】……　紋章の謎"
        ],
        [
            "p",
            "(NMotE) ... New Mystery of the Emblem",
            "【新暗黒】……　新・暗黒竜と光の剣"
        ],
        [
            "p",
            "(GHW) ... Genealogy of the Holy War",
            "【聖戦】……　聖戦の系譜"
        ],
        [
            "p",
        ...
        [
            "p",
            "(Binding) ... The Binding Blaze",
            "【封印】……　封印の剣"
        ],
        [
            "p",
            "(Blazing) ... The Blazing Blade",
            "【烈火】……　烈火の剣"
        ],
        [
            "p",
        ...
        [
            "p",
            "(Website) ... Thracia 776's Old Official Website",
            "【公式サイト】……　トラキア776・旧公式サイト"
        ]
    ],
    //page 4
    [
        ...
        [
            "p",
            "It's been 20 years, 20 years indeed!",
            "20年ですよ　20年！"
        ],
        [
            "p",
            "People who were born in the same year as FE are also adults now!",
            "FEと同じ年に生まれた人も成人しているってもんですよ！"
        ],
        [
            "p",
            "I look forward to the further development of the FE series in the future!",
            "これからもFEシリーズの更なる発展を期待しております！！"
        ],
        [
            "p",
            "Senri Kita",
        ...
        [
            "p",
            `Involved in character design and illustration for the fighting action game series "Samurai Shodown" and "SNK vs. CAPCOM." As a member of the creator team "Engines," also handles the illustration work for "Fire Emblem: Path of Radiance" and "Fire Emblem: Radiant Dawn.`,
            "格闘アクションゲーム『サムライスピリッツ』シリーズや『SNKvs.CAPCOM』のキャラクターデザイン、イラストレーションを手がける。クリエーターチーム“エンジンズ”に所属し『ファイアーエムブレム　蒼炎の軌跡／暁の女神』のイラストレーションを手がける。"
        ]
    ],
    //page 5
    [
        ...
        [
            "p",
            `Freelance illustrator actively working in various genres such as book illustrations, games, and anime. Some notable works include character concept design for the TV anime "Genesis of Aquarion"`,
            "フリーイラストレーター。挿画、ゲーム、アニメなど幅広いジャンルで活動中。代表作はTVアニメ『創聖のアクエリオン』キャラクター原案など。"
        ]
    ],
    //page 6
    [
        ...
        [
            "p",
            "I'm looking forward to the new releases as well!",
            "新作も楽しみにしています！"
        ],
        [
            "p",
            "I was impressed by the smooth and beautifully animated combat sequences of Celica in Gaiden.",
            "ぬるぬるきれいに動く戦闘アニメに感動した外伝のセリカ"
        ],
        [
            "p",
            "I played a lot of Genealogy of the Holy War and Mystery of the Emblem, for sure!",
            "紋章と聖戦は本当にたくさん遊びました！"
        ],
        [
            "p",
            "I really liked the atmosphere and characters in Path of Radiance and Radiant Dawn, where the same favorite character would always end up with a high victory rank.",
            "戦勝ランク上位がいつも同じお気に入りの人になってしまった蒼炎～暁<br>物語と雰囲気がとても好きでしたキャラも"
        ],
        [
            "p",
        ...
        [
            "p",
            `A manga artist. Known for works like "Hidamari no Pinyu" (Square Enix). Since 2010, has been active in various places, including publishing "Sora-goe" in "Dengeki Daioh Genesis" (ASCII Media Works).`,
            "漫画家。代表作に『陽だまりのピニュ』（スクエア・エニックス）。2010年以降は『電撃大王GENESIS』（アスキー・メディアワークス）にて「空声」を発表するなど各所で活躍中。"
        ]
    ],
    //page 7
    [
        [
            "p",
            `Among all the games I have played, the time I spent on "Mystery of the Emblem" and "Genealogy of the Holy War" is unparalleled.`,
            "今まで遊んだゲームの中で、紋章と聖戦に費した時間はダントツです。"
        ],
        [
            "p",
            "I grew up alongside Fire Emblem and became an adult.",
            "FEと一緒に大人になりました。"
        ],
        [
            "p",
            "I have high expectations for the new Fire Emblem games in the future as well!",
            "これからの新しいFEにも超期待！です。"
        ],
        [
            "h3",
        ...
        [
            "p",
            `Currently serializing "Landreaall" in Ichijinsha's "Comic ZERO-SUM" and "Samurai Vampire" in Ohta Publishing's "Erotics F".`,
            "一迅社「コミックZERO-SUM」で「Landreaall（ランドリオール）」、太田出版「エロティックス・エフ」で「侍ばんぱいや」を連載中。"
        ]
    ],
    //page 8
    [
    ...
    [
        ...
        [
            "h2",
            "The second installment for the GBA that depicts events 20 years before the previous game.",
            "前作の20年前を描いたGBA第２弾"
        ],
        [
            "p",
            `This is a sequel to "The Binding Blade," and the story takes place on the same continent, the Elibe continent. The main characters are Lyn, a nomadic girl, Eliwood, the Marquess of Pherae, and his close friend Hector. By the way, Eliwood is the father of Roy, the protagonist of the previous game.`,
            "『封印の剣』の続編で、物語の舞台は前作と同じエレブ大陸。主人公は、遊牧民の少女リンとフェレ領公子エリウッド、そしてその親友であるヘクトル。ちなみに、エリウッドは、前作の主人公ロイの父親である。"
        ],
        [
            "p",
            `The story is divided into three parts: "Lyn's Tale," "Eliwood's Tale," and "Hector's Tale." "Lyn's Tale" serves as a full tutorial for the entire game. In "Eliwood's Tale" and "Hector's Tale," there are several potential heroines, and the ending changes based on the specific character the protagonist achieves an A Support with. Additionally, the game introduces a unique feature called the "Tactician System," allowing players to appear as a tactician in the game, advising the main characters during battles.`,
            "物語は「リン編」「エリウッド編」「ヘクトル編」の三部構成となっており、序章にあたる「リン編」は全編チュートリアルとなっている。「エリウッド編」「ヘクトル編」にはそれぞれヒロイン候補が数人おり、主人公が特定の相手と支援Aになると、エンディングが変化する。また、「軍師システム」という独自のシステムが採用されており、プレイヤーの分身を、主人公たちの軍師としてゲーム中に登場させることが可能になった。"
        ],
        [
            "p",
            `⬆️The story begins with a scene where Lyn nurses the tactician back to health. From then on, the tactician accompanies Lyn and Eliwood on their journey.`,
            "⬆️物語は、リンが軍師を介抱する場面から始まる。以降、軍師はリンやエリウッドの旅に同行することとなる。"
        ],
        [
            "p",
            `⬆️In the previous game, Eliwood was afflicted by an illness. In this game, you can see him in good health as he travels to various places with his companions.`,
            "⬆️前作では、病に冒されたエリウッド。本作では、仲間とともに各地を旅する元気な姿を見ることができる。"
        ],
        [
            "hr"
        ],
        ...
        [
            "h2",
            "The third installment for the Game Boy Advance features two main protagonists!",
            "GBA第３作は２人の主人公が登場！"
        ],
        [
            "p",
            `The third installment for the Game Boy Advance. The story is set on the Magvel continent and focuses on the struggle of two siblings, Prince Ephraim and Princess Eirika of the Renais Kingdom, who are facing an invasion by the empire. By the way, there is no direct storyline connection to "The Binding Blade" or "The Blazing Blade" in this game.`,
            "GBA第３弾。舞台はマギ・ヴァル大陸。帝国の侵略を受けたルネス王国の２人の兄妹、王子エフラムと王女エイリークの戦いが描かれる。ちなみに、『封印の剣』および『烈火の剣』にストーリーのつながりはない。"
        ],
        [
            "p",
            `In this game, there is a branching point in the story, and depending on whether you choose Ephraim or Eirika at this point, the subsequent storyline and battle maps will change. Additionally, there's the "Split Promotion," allowing you to choose between two advanced classes after promotion, and the introduction of "EX Maps," which are battle maps that can be attempted multiple times. The "Skill System," which was not present in the previous two GBA games, makes a return in this installment. Furthermore, the tutorial mode is well-developed, making it beginner-friendly and accessible even to those new to the series.`,
            "本作では、物語の途中に分岐点が用意されており、そこでエフラムとエイリークのどちらを選ぶかで、その後のストーリー展開やバトルマップが変化する。さらに、上位へのクラスチェンジ後の兵種を２種類から選べる「分岐クラスチェンジ」や、何度も挑戦可能なバトルマップ「EXマップ」なども導入。GBA版前２作にはなかった「スキルシステム」も、本作では復活した。また、チュートリアルモードも充実しており、シリーズの初心者でも遊びやすい作りとなっている。"
        ],
        [
            "p",
            `⬆️Ephraim and Eirika initially take separate paths in the story, but as the narrative reaches its climax, they eventually reunite.`,
            "⬆️それぞれ別行動をとっていたエフラムとエイリークだが、物語が佳境にさしかかるころには合流を果たす。"
        ],
        [
            "p",
            `⬆️The "Trainee Class," which can undergo two class changes, makes an appearance. They have the potential to become powerful units and serve as key assets to the team.`,
            "⬆️クラスチェンジが２回可能な「見習いクラス」が登場。彼らは、部隊の主戦力となりうる強力ユニットだ。"
        ],
    ],
    //page 15
    [
        ...
        [
            "h2",
            "The first installment in the series with 3D graphics!",
            "シリーズ初の3Dグラフィック！"
        ],
        [
            "p",
            `Set in the blessed land of Tellius, a young mercenary named Ike rises to help a princess from a fallen kingdom and work toward the restoration of her kingdom. This game marked the series' return to console gaming systems and brought about significant advancements. It introduced 3D maps for the first time in the series, incorporated cinematic storytelling through movies, and significantly improved the battle animations.`,
            "女神に祝福されし大地テリウスを舞台に、若き傭兵のアイクが、亡国の姫を助けて王国再興のために立ち上がる。久々の据え置き型ゲーム機用タイトルで、多くの面で進化を遂げている。シリーズ初となる3Dマップに加え、ムービーによる演出を採用。もちろん、バトルの演出も大幅にパワーアップした。"
        ],
        [
            "p",
            `Apart from improvements in presentation, there were significant advancements in gameplay systems. Notable additions included an evolved "Skill System," a feature called "Transformation" involving special units known as "Laguz," and the ability to forge weapons in the "Base." New elements were introduced as well. The game offered three difficulty levels: "Normal," "Hard," and "Maniac," with "Maniac" being particularly challenging, rivaling the difficulty of "Thracia 776."`,
            "演出面のほか、システム面の進化も顕著。進化を遂げた「スキルシステム」をはじめ、ラグズと呼ばれる特殊ユニットによる「化身」、武器錬成も可能な「拠点」など、新要素も追加された。難易度も「ノーマル」「ハード」「マニアック」の3種類があり、中でも「マニアック」は、『トラキア776』に匹敵する手強さとなっている。"
        ],
        [
            "p",
            `⬆️The transition to 3D brought about battle maps with greater visual depth. There was also an increase in the variety of maps available in the game.`,
            "⬆️3Dになったバトルマップ。マップのバリエーションも増えている。"
        ],
        [
            "p",
            `⬆️The game introduced "Biorhythm," a system that indicated the condition of characters' performance based on their rhythm, affecting their parameters.`,
            "⬆️キャラのパラメータに、調子の良し悪しを示す「バイオリズム」が登場。"
        ],
        [
            "h1",
        ...
        [
            "p",
            "Release date: February 22nd 2007.",
            "発売日：2007年2月22日"
        ],
        [
            "p",
        ...
        [
            "h2",
            `A sequel set three years after "Path of Radiance."`,
            "『蒼炎の軌跡』の３年後の描いた続編"
        ],
        [
            "p",
            `The game is set in a world three years after the events of the previous installment, "Path of Radiance." The kingdom of Daein, defeated in the previous war, now finds itself under the control of the Empire. To save the people from the Empire's oppression, Micaiah joins the fight.`,
            "前作『蒼炎の軌跡』から３年後の世界が舞台。先の戦争で敗北し、帝国の支配下に置かれることとなったデイン王国。帝国の圧政から人々を救うために、ミカヤは戦いにその身を投じる。"
        ],
        [
            "p",
            `Many characters who played prominent roles in "Path of Radiance," including Ike, make appearances in this game. It's divided into four parts, with the story unfolding from the perspectives of different characters in the first three parts. In terms of gameplay systems, it generally follows the conventions of the previous game. However, with the platform shift from the Nintendo GameCube to the Wii, there were significant improvements in presentation, including enhanced cutscenes. Additionally, players had the incentive of special events when importing clear data from "Path of Radiance" to this game.`,
            "アイクをはじめ、『蒼炎の軌跡』で活躍したキャラクターも数多く登場する。全四部構成となっており、第１部から３部までは、それぞれ異なる人物の視点で物語が進められる。システム面に関しては、基本的には前作を踏襲しているが、プラットフォームがニンテンドーゲームキューブからWiiに移ったことで、ムービーなどの演出面は大幅にパワーアップしている。また、『蒼炎の軌跡』のクリアデータを引き継いでプレイすると、特別なイベントが発生するという特典もあった。"
        ],
        [
            "p",
            `⬆️The main character in Part 1 is Micaiah. Ike, on the other hand, is the main character in Part 3.`,
            "⬆️第１部の主人公であるミカヤ。ちなみに、アイクは第３部の主人公。"
        ],
        [
            "p",
            `⬆️The game featured greatly enhanced cinematic scenes with improved visuals and graphics.`,
            "⬆️演出、グラフィックともにパワーアップしたムービーシーン。"
        ],
    ],
    //page 16
    [
        ...
        [
            "h2",
            `The series' origin is revived on the DS!`,
            "シリーズの原点がDSで蘇る！"
        ],
        [
            "p",
            `This is "Shadow Dragon," a renewal of the game that can be considered the series' origin, "Shadow Dragon and the Blade of Light," on the DS. It includes an additional "Prologue" depicting Marth's escape from Altea at the beginning. Furthermore, it adds side stories for new characters like Horace and Etzel.`,
            "シリーズの原点ともいえる『暗黒竜と光の剣』に新たなエピソードを加えてリニューアルされたのが、本作『新・暗黒竜と光の剣』。冒頭に、マルスのアリティア脱出までを描いた「序章」を追加。さらに、ホルスやエッツェルなど、新キャラクターのサイドストーリーが追加されている。"
        ],
        [
            "p",
            `Under the renewal for "Shadow Dragon," elements like the "Weapon Triangle" and "Support Relationships" were introduced, which were not present in the original "Shadow Dragon and the Blade of Light." Furthermore, a new feature called "Class Change" allows you to freely choose your allies' classes from a set of patterns. Additionally, the game implemented a "Checkpoint Save System", allowing you to save and resume at any point, making it more accessible for beginners to the series.`,
            "リニューアルにあたり、『暗黒竜と光の剣』にはなかった「武器の３すくみ」や「支援関係」を採用。さらに、新要素として、仲間の兵種をパターンの中から自由に選べる「兵種変更」も加わった。また、何度も再開可能な途中セーブ、「ポイントセーブシステム」が採用され、シリーズ初心者でも遊びやすい作りとなっている。"
        ],
        [
            "p",
            `⬆️The introduction of the Checkpoint Save System allows for retrying sections of a map in the middle of a chapter.`,
            "⬆️ポイントセーブシステムの導入により、MAP途中でのやり直しが可能に。"
        ],
        [
            "p",
            `⬆️With the addition of a prologue and the introduction of new characters, there are new discoveries for fans to enjoy in the game.`,
            "⬆️序章の追加や新キャラクターの登場など、ファンにも新たな発見がある。"
        ],
        [
            "h1",
        ...
        [
            "p",
            "Release date: September 29th 1997 (beginning of broadcasting).",
            "発売日：1997年9月29日配信開始"
        ],
        [
            "p",
        ...
        [
            "h2",
            `An elusive work depicting the fall of Archanea.`,
            "アカネイア陥落が描かれた幻の作品"
        ],
        [
            "p",
        ...
        [
            "p",
            `This game was previously considered a "phantom work" among fans, but it was resurrected and included in "Fire Emblem: New Mystery of the Emblem" as "New Archanea Chronicles."`,
            "これまではファンの間で「幻の作品」とされてきた本作だが、『新・紋章の謎』に収録され、「新・アカネイア戦記」として復活を果たす。"
        ],
        [
            "h3",
            `What is Satellaview?`,
        ...
        [
            "p",
            `The Satellaview is a satellite broadcast adapter released in 1995 for the Super Famicom. By connecting this adapter, it was possible to receive game data broadcasts via satellite. Game data broadcasting ended in the year 2000.`,
            "1995年に発売された、スーパーファミコン用の衛星放送アダプタ。このアダプタを接続することで、衛星データ放送によるゲームデータ配信を受信することができた。ゲームのデータ放送は2000年に終了している。"
        ],
    ],
    //page 17
    [
        ...
        [
            "p",
            "Shadow Dragond and the Blade of Light, Mystery of the Emblem, Gaiden, Shadow Dragon, Archanea Saga.",
            "暗黒竜と光の剣、紋章の謎、外伝、新・暗黒竜と光の剣、アカネイア戦記編"
        ]
    ],
    //page 18
    [
        ...
        [
            "p",
            `100 years after the hero Anri defeated the Shadow Dragon Medeus, Medeus suddenly resurrected. Teaming up with the evil high priest Gharnef, Medeus revived the Dolhr Empire and conquered the previously peaceful continent of Archanea.`,
            "英雄アンリが暗黒竜メディウスを倒して１００年後……突如としてメディウスは復活した。悪の司祭ガーネフと手を組んだメディウスは、ドルーア帝国を再興。それまで平和だったアカネイア大陸を制圧する。"
        ],
        [
            "p",
            `Marth, the prince of Altea, who carries the bloodline of Anri, lost his parents and sought refuge on the remote island nation of Talys. However, when Dolhr's evil influence also reached Talys, Marth, along with a small group of soldiers, took up arms in the fight against Dolhr.`,
            "アンリの血を引くアリティアの王子マルスは、父母を失い、辺境の島国タリスへと逃げのびていた。しかし、タリスにもドルーアの魔の手が迫るに至り、マルスはわずかな兵とともに反ドルーアの戦いに身を投じるのである……"
        ],
        [
            "p",
            `This conflict, later known as the War of Shadows, came to an end thanks to Marth's efforts. Medeus was defeated, and the Dolhr Empire crumbled. People began working tirelessly to rebuild their devastated homeland.`,
            "後に暗黒戦争と呼ばれたこの戦いは、マルスの活躍によって終わりを告げた。メディウスは討たれ、ドルーア帝国も崩壊。人々は荒れ果てた祖国の再建に力を尽くし始めた。"
        ],
        [
            "p",
            `One year later, as Marth was about to wed Princess Caeda, a letter arrived from Emperor Hardin, who had ascended to the throne of Archanea. It contained a simple command: "Suppress the rebellion in Grust." Little did they know that this single letter would mark the beginning of what would later be known as the War of Heroes.`,
            "それから１年。シーダ姫との婚礼を間近に控えたマルスのもとに、アカネイアの皇帝となったハーディンから書簡が届く。「グルニアの反乱軍を討伐せよ」。その１通りの書簡が、後に英雄戦争と呼ばれる戦いの幕開けとなる＿＿。"
        ]
    ],
    //page 19
    [
