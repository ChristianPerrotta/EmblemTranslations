...
export const description = [
    ...
    "Since the book contains many personal names writen exclusively in kanji, especially on page 240, their readings may not be accurate, as there is not always a single way to read personal names in Japanese without a reference.",
