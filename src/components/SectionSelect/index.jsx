            ...
            <div className="row">
                <div className="col">
                    <div className="form-floating">
                        <select className="form-select" id="section" name="sectionlist"
                        ...
                        <label for="sectionlist" className="form-label">Choose a section:</label>
                    </div>
                </div>
                ...
                <div className="col">
                    <div className="form-floating">
                        ...
                        <select className="form-select" id="subsection" name="subsectionlist"
                        ...
                        <label for="subsectionlist" className="form-label">Choose a subsection:</label>
                    </div>
                </div>}
